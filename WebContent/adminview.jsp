		...
		<div id="sidebar-wrapper" data-simplebar=""
			...
			<ul class="sidebar-menu do-nicescrol">
				...
				<li><a href="byproduct.jsp"> <i
						class="zmdi zmdi-view-dashboard"></i> <span>Admin</span>
				</a></li>
...
<center>	
  <div id="page-wrapper" style="background-color:rgb(183, 218, 241);margin-top:10%;margin-left:19%;" > 
			...
			<tr>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Product Id</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Product Name</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Seller</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Category</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Production Description</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Funding Amount</th>
                    <th style="background-color:rgb(5, 26, 43); color:white;">Document</th>
                     <th style="background-color:rgb(5, 26, 43); color:white;">Approve</th>
                      <th style="background-color:rgb(5, 26, 43); color:white;">Delete</th>
           </tr>
			 ...
			 <%
            		...
            		try
            		{
            			...
            			PreparedStatement ps1=con.prepareStatement("select * from product where status=? ");
                    ...
                    %>
                       <tr>
                          ...
                          <td ><a href="viewDocument.jsp?pid=<%=rs.getString(1)%>">view</a></td>
                          <td ><a href="approve.jsp?pid=<%=rs.getString(1)%>">approve</a></td>
                          <td ><a href="pdelete.jsp?pid=<%=rs.getString(1)%>">Delete</a></td>
                      </tr> 
                    <%
            			}
            		}catch(Exception e)
