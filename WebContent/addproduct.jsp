  ...
  <div id="sidebar-wrapper" data-simplebar=""
			...
			<li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="addproduct.jsp"><i class="fa fa-angle-right"></i>Add Product</a></li><br>
                  <li><a href="viewproduct.jsp"><i class="fa fa-angle-right"></i> View Product</a></li>
                </ul>
              </li>
              <br>
      ...
      <div class="col-lg-6">
         <div class="card">
           ...
           <div class="form-group">
            ...
            <input type="text" name="pname" class="form-control" id="input-1" placeholder="Product name">
           </div>
           <div class="form-group">
            <label for="input-2">Category</label>
            <input type="text"  name="category"class="form-control" id="input-2" placeholder="Category">
           </div>
          
           <div class="form-group">
            <label for="input-4">Description</label>
            <input type="text" name="pdesc"class="form-control" id="input-4" placeholder="Description">
           </div>
           <div class="form-group">
            <label for="input-5">Price</label>
            <input type="number" name="pamt"class="form-control" id="input-5" placeholder="Product amount">
           </div>

           <div class="form-group">
            <label for="input-3"> add image</label>
            <input type="file" name="file" class="form-control" id="input-3" placeholder="choose file">
           </div>
           ...
           <div class="form-group">
            <button type="submit" class="btn btn-light px-5"><i class="icon-add"></i> Add</button>
          </div>
          </form>
         </div>
         </div>
